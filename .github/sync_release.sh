...
UPSTREAM_REPO="https://github.com/MiSTer-devel/ColecoAdam_MiSTer.git"
CORE_NAME=(ColecoAdam)
...
UPSTREAM_CORE_NAME=(ColecoAdam)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(ColecoAdam.qpf)
COMPILATION_OUTPUT=(output_files/ColecoAdam.rbf)
